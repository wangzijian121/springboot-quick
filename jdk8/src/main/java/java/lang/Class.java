 ...
 * enum是一种类，annotation是一种接口。每个数组还属于一个反映为class对象的类，该对象由具有相同元素类型和维数的所有数组共享。
 * 基本Java类型(boolean、byte、char、short、int、long、float和double)和关键字void也表示为Class对象。
 */
public final class Class<T> implements java.io.Serializable,
    ...
    private Class(ClassLoader loader) {
        //为classLoader初始化final字段。
        // non-null的初始化值可以防止将来的JIT优化假设这个最终字段为空。
        classLoader = loader;
    }
